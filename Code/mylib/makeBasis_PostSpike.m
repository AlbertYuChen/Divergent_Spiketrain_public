function [iht, ihbas, ihbasnorm] = makeBasis_PostSpike(ihprs, dt, iht0)
...
ihbasnorm = bsxfun(@rdivide,ihbasis,sqrt(sum(ihbasis.^2))); % normalize columns to be unit vectors
ihbas = orth(ihbasnorm);  
