function [kbasorth, kbasnorm] = makeBasis_StimKernel(kbasprs, nkt)
...
kbasis = flipud(kbasis); 
kbasnorm = bsxfun(@rdivide,kbasis,sqrt(sum(kbasis.^2))); % normalize columns to be unit vectors
kbasorth = orth(kbasnorm);
